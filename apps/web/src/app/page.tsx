              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                ...
                <div>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                    <p style={{ color: "#555555", fontSize: "0.75rem", lineHeight: 1.5, margin: 0 }}>
                      All posts expire after 30 days. You can only post from your current GPS location, but you can browse and vote from anywhere. Content is moderated by AI agents following our public Constitution. No humans moderate this app.
                    </p>
                  </div>
                </div>
              </div>
