...
const FALLBACK_SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "IV.7", section: "IV", heading: "MODERATION PROCESS", tag: "IV.7", text: "Escalating cooldowns. When a post is removed for violating the Constitution, the poster receives an escalating posting cooldown. Strike 1: 5 minutes. Strike 2: 30 minutes. Strike 3: 2 hours. Strike 4: 12 hours. Strike 5+: 24 hours. Strikes are counted over a rolling 24-hour window. Cooldowns apply to both anonymous and authenticated users." },
      { id: "IV.8", section: "IV", heading: "MODERATION PROCESS", tag: "IV.8", text: "Rejection transparency. Users can view their rejected posts and the AI's explanation for why each post was removed. This is available at /my-posts (authenticated) or via the API. The moderation reasoning is never hidden from the poster." },
      { id: "IV.9", section: "IV", heading: "MODERATION PROCESS", tag: "IV.9", text: "Evasion detection. The AI moderator is trained to detect common evasion techniques including but not limited to: character substitution (leetspeak, unicode lookalikes), coded language, spaced letters, context tricks ('just a joke'), and obfuscation. Attempting to evade moderation is itself a violation and may result in an immediate strike." },
    ],
  },
  {
    id: "V",
    ...
    items: [
      ...
      { id: "V.4", section: "V", heading: "FEED ALGORITHM", tag: "V.4", text: "Time decay. All posts lose ranking over time via gravity factor (age_hours + 2)^1.2. A post that was hot 12 hours ago will naturally fall as newer content arrives. Posts expire from public feeds after 48 hours but remain saved to the poster's account history." },
