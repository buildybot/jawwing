...
const sections = [
  {
    title: "1. Who We Are",
    body: `Jawwing is an anonymous, location-based social platform. We let people post short public content tied to a geographic location — no account required, no identity required. Posts expire from public feeds after 5 days but remain in your account history. Content is moderated by AI, not humans.
...
Section 230 Notice: Jawwing is an interactive computer service provider, not the publisher or speaker of user-submitted content. We claim all applicable protections under 47 U.S.C. § 230 to the fullest extent permitted by law.`,
  },
  {
    ...
    body: `Images are stored on Vercel Blob CDN, are publicly visible as part of your post, and are automatically deleted when the post expires from feeds (~5 days). All uploaded images are scanned by AI moderation for prohibited content.
...
We do not guarantee that the Service will be available at any given time, that content will be accurate, that moderation will catch all prohibited content, that your anonymity will be preserved, or that posts will expire at exactly 5 days.`,
  },
  {
